...
namespace EOSPlugin.Utility
{
    public static class Settings
    {
        public static string ProductId { get; private set; } = "<PID>";
        public static string SandboxId { get; private set; } = "<SID>";
        public static string DeploymentId { get; private set; } = "DID";
        public static string ClientId { get; private set; } = "CID";
        public static string ClientSecret { get; private set; } = "CS";
